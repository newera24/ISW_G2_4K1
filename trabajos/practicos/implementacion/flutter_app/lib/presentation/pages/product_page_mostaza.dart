...
class ProductPageMostaza extends StatelessWidget {
  const ProductPageMostaza({Key? key}) : super(key: key);
            ...
            child: Center(
              child: PurpleButton(
                  ...
                  onPressed: () {
                    ...
                    if (sushiCartController.cart.isNotEmpty) {
                      Get.snackbar('Error', 'No se pudo agregar al carrito',
